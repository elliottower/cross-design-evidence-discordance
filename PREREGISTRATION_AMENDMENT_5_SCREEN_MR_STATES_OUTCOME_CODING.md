...
2026-09-22  Procedure 1 run (analysis/amendment5/run_screen.py): universe 279, resolved 219 (189 launched, 30 failed); exact coverage 0/219 (one universe row reached, IL23R-Psoriasis, pending), expanded 14/219; 25-row sample drawn (seed 20260922) and checked: 4/25 MR-eligible (3/25 under a narrow reading of the VEGFA-myopia hit)
2026-09-22  Procedure 2 run (run_mr_states.py): scored 32 = supportive 15 (12 correct), negligible-range 7 (6), inconclusive 10 (6); registered null 17 = 7 negligible + 10 inconclusive; 8 scale-unresolved; no registered classification changed
2026-09-22  IL6-MDD deviation items: (3) source of OR 1.01 (0.99-1.04) identified as Galan 2022 Sci Rep PMID 36057695 (polygenic CRP MR, 512 instruments); estimate retained. (4) fixed query returned 8 results, 1 eligible: Kelly 2021 PMID 33631287, OR 1.023 (1.006-1.039), d 0.013 (0.003-0.021), null; registered score unchanged; registration-consistent row = 24/32
2026-09-22  Procedure 3 run (codebook/, 41 families, three coders' files): 12 families carry a not-reported field; four scored families (ModRisk-AD, Smoking-MS/AD, BMI-AD, EBV-MS) have no drug program named anywhere in the repository and all seven fields are not reported; codebook disagrees with the registered outcome on CRP and IL-1b-CVD (CANTOS met its primary endpoint at 150 mg; "Failed"/"No benefit" hold as regulatory composites), VitaminD-MS (mixed readouts), Triglycerides and HDL/CETP (class-level mixed)
2026-09-22  Procedure 4 run (run_analysis_sets.py): registered 24/32; strict Phase III 17/25 (removes IL6-MDD [Phase II], Blood pressure and Triglycerides [coded mixed class], and the four program-less families); Amyloid-AD scored 24/33; both 17/26; MR-instrumented 22/27 (audit finds five association legs: Complement-GA, Serotonin-MDD, IL-23-psoriasis, CTLA-4-RA, JAK-STAT-RA; three unresolved kept and listed: BMI-AD, EBV-MS, CD20-RA; also reported with unresolved removed, 19/24); registration-consistent instrument 24/32; unique-evidence 23/31 (Niacin/HDL collapsed); source-extracted OBS 20/25 as registered, and 21/27 by the classifier's own author_estimated flags, because IL6-MDD (Howren 2009) and Serotonin-MDD (Ogawa 2014) carry meta-analytic observational values and the manuscript's dagger marks on them were wrong; Amendment 4 23/28. No set promoted.
2026-09-22  MR-instrumented audit, second source search: BMI-AD traced to Li 2021 PMID 34057091 (OR 1.03, 1.01-1.05) and CD20-RA to SSRN 4709115 (OR 1.291, 1.190-1.391; preprint, read by search only), both MR-instrumented; Metabolic-AD's stored 1.01 traced to Walter 2016 PMID 26650880 (0.96-1.06); EBV-MS 5.0 (2.0-20.0) untraced. Row 'unresolved also removed' becomes 21/26 (was 19/24). Other rows unchanged.
2026-09-24  analysis set added after the results were seen: 'documented Phase III program' (registered set without the four families whose outcome has no documented drug program: ModRisk-AD, Smoking-MS/AD, BMI-AD, EBV-MS). Reason: the registration's inclusion rule requires a Phase III readout; these four were scored without one. All four are hits; the set scores 20/28. Reported beside the registered result, not in place of it.
```
