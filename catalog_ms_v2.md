# Mechanistic Validity — Multiple Sclerosis Mechanism Catalog (Xia Program)

**Build date:** 2026-06-30
**Author context:** Elliot Tower — MechViews / Mechanistic Validity / MechRef program, applied to Dr. Zongqi Xia's
clinical-translational neuroimmunology (MS, AD, GEMS cohort, digital phenotyping, RWE).
**Format:** Mirrors the Mechanistic Validity Public-Health Bible and Cross-Disorder Capstone — each mechanism
claim is decomposed into causal legs, assigned a **View** (Object / Role / Subspace / Structural /
Process), scored on the **Mechanistic Validity tier scale** (Descriptive, Observationally Consistent,
Causally Suggestive, Mechanistically Supported), given a **verdict**, and where a claim
...
Mechanistic Validity/MechRef machinery as the engine underneath. The recurring MS-specific rule mirrors the
...
|---|---|
| Descriptive | A reproducible phenomenon / association |
| Observationally Consistent | Survives covariate adjustment, replicates across cohorts |
| Causally Suggestive | Temporal order + instrument (MR/genetics) or negative-control design |
| Mechanistically Supported | Direct perturbation / treatment engagement changes the target as predicted |

**Verdict tags:** SUPPORTED · CAUSALLY SUGGESTIVE · UNDERDETERMINED · DISCONFIRMED · REFERENCE-DEBT
...
**Tier assignment:**
- c1: **Observationally Consistent** (robust, replicated). c2: **Causally Suggestive** (temporal order + NfL sequencing = causally suggestive).
- c3: **Causally Suggestive** (virome-wide specificity, CMV negative control). c4: **approaching Mechanistically Supported** (near-necessity
  is the strongest epi claim in MS). c5: **Descriptive to Observationally Consistent** (mechanism of HOW EBV causes MS is NOT established —
...
**Xia hook:** This is the cleanest Causally Suggestive causal claim in MS and the template for the whole catalog —
...
**Tier assignment:**
- c1: **Observationally Consistent** (reproducible imaging phenotype). c2: **Observationally Consistent** (association, confound-prone — see below).
- c3: **Causally Suggestive** (compartmentalization supported by pathology + BTK-inhibitor pharmacology, Case 003).
- c4: **Observationally Consistent to Causally Suggestive** (the relapse-independent axis is real but its identity as a single mechanism is not settled).

**Verdict:** **CAUSALLY SUGGESTIVE, trending SUPPORTED** (strengthened by convergent BTK-inhibitor evidence).
...
**Tier assignment:**
- c1: **Causally Suggestive to Mechanistically Supported** (pharmacological target engagement). c2: **Mechanistically Supported** (RCT with disability-progression primary
  endpoint = the gold-standard interventional ground truth for a progression mechanism) [web:705].
- c3: **Causally Suggestive** (the RCT licenses the mechanism inference for PROGRESSION specifically).
...
**Tier assignment:** Both DAGs sit at **Observationally Consistent** (each consistent with observational data). Neither reaches
Causally Suggestive because no instrument/temporal design has been applied to adjudicate PRIMACY.

**Verdict:** **UNDERDETERMINED / UNDERDETERMINED — the scoring unit is the instantiated causal path, not the umbrella.**
...
|---|---|---|
| EBV etiology (001) | SUPPORTED as trigger / UNDERDETERMINED as molecular mechanism | Strongest Causally Suggestive causal claim in MS; mechanism leg carries reference debt |
| Smoldering / iron-rim (002) | CAUSALLY SUGGESTIVE; confound-prone | Bracket-norm audit target; real axis, fragile metric |
...
| Inflammation-first vs degeneration-first (004) | UNDERDETERMINED | Score instantiated legs; sheaf-cohomology adjudication |
...
**Tier assignment:** c1 **Causally Suggestive to Mechanistically Supported** (mechanistically tied to axonal release). c2 **Causally Suggestive** (prospective,
temporal, dose-graded — strong prognostic). c3 **Causally Suggestive** (holds in progressive MS) [web:723]. c4 **Observationally Consistent to Causally Suggestive**
(readout of damage, but "mechanism" overstates — it is a *marker* of the process, not a causal lever).

**Verdict:** **SUPPORTED as a prognostic/monitoring biomarker of the neurodegeneration axis; CAUSALLY SUGGESTIVE
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive** (robust diagnostic hallmark). c2 **Descriptive to Observationally Consistent, HETEROGENEOUS** — the
prognostic direction FLIPS across cohorts/populations [web:736][web:740]. c3 **Descriptive** (antigen mostly
unknown) [web:738].

**Verdict:** **SUPPORTED as a diagnostic marker; UNDERDETERMINED as a prognostic mechanism; UNDERDETERMINED
...
**View:** Structural (etiological), tested with a genetic instrument (MR = the Causally Suggestive lever).
...
**Tier assignment:** c1 **Observationally Consistent**. c2 **Causally Suggestive** (multiple independent MR studies, pleiotropy-robust —
one of the best-instrumented causal claims in MS) [web:727][web:724]. c3 **Causally Suggestive** (VDR-binding mechanism
supported) [web:726]. c4 **Descriptive to Observationally Consistent** (no positive prevention RCT).
...
positive control for a Mechanistic Validity MR-scoring pipeline (contrast with the confounded CRP-in-depression case
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive** (large, household-controlled — better than typical microbiome studies).
c2 **Observationally Consistent to Causally Suggestive** [web:716]. c3 **Descriptive to Observationally Consistent** (association + biological plausibility; NO perturbational causal proof
in humans; reverse causation / treatment confounding live). c4 **Observationally Consistent** (mechanistically suggestive) [web:716].

**Verdict:** **CAUSALLY SUGGESTIVE (association is unusually clean); UNDERDETERMINED as a causal mechanism.**
...
**Tier assignment:** c1 **Causally Suggestive** (cross-reactivity demonstrated in patient cohorts). c2 **Causally Suggestive** (molecular
mapping). c3 **Causally Suggestive** (mouse-model perturbational support — approaches Mechanistically Supported for the animal system, transports
weakly to human causation). c4 **Descriptive to Observationally Consistent** (mimicry is likely ONE of several mechanisms; sole-mechanism
claim is unsupported).

**Verdict:** **CAUSALLY SUGGESTIVE to SUPPORTED as a contributing mechanism; DISCONFIRMED as the SOLE mechanism.**

**Contraction:** Hard core c1,c2,c3 (mimicry is a real, mapped, animal-supported contributor). Discard c4.
This RESOLVES the reference debt flagged in Case 001-c5: the molecular mechanism now has genuine Causally Suggestive
support, but only as *a* pathway, not *the* pathway. Update Case 001-c5 from Descriptive to Observationally Consistent to **Causally Suggestive (contributing)**.
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive**. c2 **Causally Suggestive** (large multicenter longitudinal, DGM-specific, dose-graded)
[web:742]. c3 **Observationally Consistent to Causally Suggestive** (strong substrate evidence; still partly a readout). c4 **Observationally Consistent** (phenotype-
dependent atrophy patterns complicate surrogate use — the MAGNIMS authors caution exactly this) [web:742].

**Verdict:** **SUPPORTED as the leading progression substrate/predictor; CAUSALLY SUGGESTIVE as a treatment surrogate.**
...
|---|---|---|---|---|
| 001 | EBV as trigger | Causally Suggestive (necessity) | SUPPORTED trigger / mechanism deferred | MR-style temporal design |
| 002 | Smoldering / iron-rim | Observationally Consistent to Causally Suggestive | CAUSALLY SUGGESTIVE, confound-prone | **Bracket-norm audit #1** |
| 003 | BTK / compartmentalized inflammation | Mechanistically Supported (RCT) | SUPPORTED progression / DISSOCIATED from relapse | Two-axis MechRef transport |
| 004 | Inflammation- vs degeneration-first | Observationally Consistent | UNDERDETERMINED | **Sheaf-cohomology DAG adjudication** |
| 005 | sNfL neuroaxonal readout | Causally Suggestive | SUPPORTED biomarker / not a "mechanism" | Ground-truth response variable |
| 006 | OCB / intrathecal IgG | Observationally Consistent to Causally Suggestive diag; Descriptive mech | SUPPORTED diag / UNDERDETERMINED prognosis | **H^1 non-transport demo** (genetic background modifier) |
| 007 | Low vitamin D | Causally Suggestive (MR) | SUPPORTED causal risk / treatment underdetermined | MR-scoring positive control |
| 008 | Gut microbiome | Observationally Consistent to Causally Suggestive | CAUSALLY SUGGESTIVE / causal underdetermined | Mediation-DAG gluing test |
| 009 | EBNA1-GlialCAM mimicry | Causally Suggestive (contributing) | SUPPORTED contributor / DISCONFIRMED as sole | Cross-species MechRef transport |
| 010 | Deep GM atrophy | Causally Suggestive | SUPPORTED substrate / surrogate suggestive | **Bracket-norm audit #2** + phenotype H^1 |

## Consolidated MS-specific findings

**The two dominant rules (both are MechRef/Mechanistic Validity failure modes):**
...
**Best-validated claims:** BTK-progression (003, Mechanistically Supported RCT) > EBV-necessity (001, Causally Suggestive) ~ vitamin-D-MR
(007, Causally Suggestive) ~ deep-GM-atrophy (010, Causally Suggestive) ~ sNfL-prognosis (005, Causally Suggestive).
...
**Tier assignment:** c1 **Mechanistically Supported** (direct depletion). c2 **Mechanistically Supported** (RCT relapse reduction). c3 **Causally Suggestive to Mechanistically Supported**
(RCT-supported but modest, effect-modified by inflammatory activity) [web:750]. c4 **Observationally Consistent to Causally Suggestive** — the
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive**. c2 **Observationally Consistent to Causally Suggestive** [web:749]. c3 **Causally Suggestive** (pathology links meningeal
inflammation to subpial demyelination) [web:744]. c4 **Observationally Consistent** (one of several substrates; competes with
deep GM atrophy, Case 010).

**Verdict:** **SUPPORTED as a distinct pathological axis; CAUSALLY SUGGESTIVE as the primary progression substrate.**
...
**Tier assignment:** c1 **Observationally Consistent**. c2 **Causally Suggestive** (multiple pleiotropy-robust MR studies) [web:745][web:718].
c3 **Causally Suggestive** (multivariable MR pins the mediation structure — childhood effect runs THROUGH adult obesity)
[web:745]. c4 **Descriptive** (no weight-loss prevention trial).
...
form the positive-control pair for a Mechanistic Validity MR-scoring module.
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive** (plausible, pathology-supported). c2 **Observationally Consistent** (candidate mechanism).
c3 **Descriptive to Observationally Consistent, largely DISCONFIRMED at the trial level** — repeated clinical failures [web:758].

**Verdict:** **CAUSALLY SUGGESTIVE as biology; DISCONFIRMED (so far) as a therapeutic strategy.**
...
Case 015) as much as a biology problem — a Mechanistic Validity case where the validity bottleneck is the MEASURE,
not the mechanism.
...
**Tier assignment:** c1 **Causally Suggestive** (validated for physical disability). c2 **Observationally Consistent** (reliability-limited).
c3 **Descriptive to Observationally Consistent, largely DISCONFIRMED for progressive MS** [web:768]. c4 **DISCONFIRMED** — EDSS is
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive** (multi-cohort, adjusted). c2 **Observationally Consistent to Causally Suggestive, CONFOUNDING-BY-INDICATION LIVE**
— this is observational; sicker patients may be selected into either arm; the RCT (DELIVER-MS/TREAT-MS)
readouts are the needed Mechanistically Supported [web:762]. c3 **Observationally Consistent** (observational "no catch-up") [web:764].

**Verdict:** **CAUSALLY SUGGESTIVE, CONFOUNDING-LIMITED — the flagship confounding-by-indication case.**
...
|---|---|---|---|---|
| 001 | EBV trigger | Causally Suggestive | SUPPORTED trigger | Temporal causal design |
| 002 | Smoldering / iron-rim | Observationally Consistent to Causally Suggestive | CAUSALLY SUGGESTIVE, confounded | Bracket-norm #1 |
| 003 | BTK / compartmentalized inflammation | Mechanistically Supported | SUPPORTED progression / DISSOCIATED relapse | Two-axis transport |
| 004 | Inflammation- vs degeneration-first | Observationally Consistent | UNDERDETERMINED | Sheaf DAG adjudication |
| 005 | sNfL | Causally Suggestive | SUPPORTED biomarker | Ground-truth response |
| 006 | OCB / intrathecal IgG | Observationally Consistent to Causally Suggestive / Descriptive | SUPPORTED diag / UNDERDETERMINED prognosis | H^1 non-transport |
| 007 | Low vitamin D | Causally Suggestive (MR) | SUPPORTED causal risk | MR positive control |
| 008 | Gut microbiome | Observationally Consistent to Causally Suggestive | CAUSALLY SUGGESTIVE | Mediation-DAG gluing |
| 009 | EBNA1-GlialCAM mimicry | Causally Suggestive | SUPPORTED contributor / not sole | Cross-species transport |
| 010 | Deep GM atrophy | Causally Suggestive | SUPPORTED substrate | Bracket-norm #2 + phenotype H^1 |
| 011 | Anti-CD20 B-cell depletion | Mechanistically Supported | SUPPORTED treatment / OVERREACH as etiology | Age/activity H^1 modifier |
| 012 | Cortical/meningeal demyelination | Causally Suggestive | SUPPORTED axis / CAUSALLY SUGGESTIVE primary | Bracket-norm #3 + rival substrate |
| 013 | Obesity / BMI | Causally Suggestive (MR) | SUPPORTED causal risk + mediation | MR + causal-mediation template |
| 014 | Remyelination-failure -> therapy | Observationally Consistent / Descriptive | CAUSALLY SUGGESTIVE biology / DISCONFIRMED therapy | Measurement-bottleneck case |
| 015 | EDSS validity | Causally Suggestive / DISCONFIRMED linearity | Valid disability / WEAK progression measure | **Invariance / metric-axis (foundational)** |
| 016 | Early high-efficacy DMT | Observationally Consistent to Causally Suggestive | CAUSALLY SUGGESTIVE, confounded-by-indication | Fisher-Rao confound-leakage |
...
**Tier assignment:** c1 **Causally Suggestive** (robust cross-population genetic association = a natural instrument).
c2 **Causally Suggestive** (consistently strongest). c3 **Observationally Consistent to Causally Suggestive** (plausible, incompletely explanatory) [web:780].
c4 **Causally Suggestive** (expression + methylation mediation demonstrated) [web:776].

**Verdict:** **SUPPORTED as the leading genetic risk factor; mechanism (antigen presentation) CAUSALLY SUGGESTIVE
...
**Tier assignment:** c1 **Causally Suggestive** (both individually causal-suggestive: EBV Case 001, HLA Case 017).
c2 **Causally Suggestive** (meta-analytic additive interaction, though scale-dependent) [web:787]. c3 **Observationally Consistent** (mechanism
of convergence — presumably EBV-antigen presentation via DRB1*15:01 — plausible but not proven).

**Verdict:** **SUPPORTED as a statistical (additive) effect-modification; CAUSALLY SUGGESTIVE as a mechanistic
convergence.**
...
**Tier assignment:** c1 **Causally Suggestive to Mechanistically Supported** (AQP4 astrocytopathy is mechanistically well-defined). c2 **Causally Suggestive**
(MOGAD increasingly well-characterized). c3 **Causally Suggestive** (separable with criteria) [web:774]. c4 **Observationally Consistent** —
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive**. c2 **Observationally Consistent to Causally Suggestive** (consistent sex-course dimorphism) [web:783]. c3 **Causally Suggestive**
(pregnancy/postpartum is a within-person natural experiment with temporal order) [web:783]. c4 **Observationally Consistent to Causally Suggestive**
...
CAUSALLY SUGGESTIVE to SUPPORTED (pregnancy is the strongest human evidence).**
...
| # | Node | Best tier | Verdict | Machinery hook |
|---|---|---|---|---|
| 001 | EBV trigger | Causally Suggestive | SUPPORTED trigger | Temporal design |
| 002 | Smoldering/iron-rim | Observationally Consistent to Causally Suggestive | CAUSALLY SUGGESTIVE, confounded | Bracket-norm #1 |
| 003 | BTK inflammation | Mechanistically Supported | SUPPORTED progression/DISSOCIATED relapse | Two-axis transport |
| 004 | Inflamm vs degen first | Observationally Consistent | UNDERDETERMINED | Sheaf DAG adjudication |
| 005 | sNfL | Causally Suggestive | SUPPORTED biomarker | Response variable |
| 006 | OCB | Observationally Consistent to Causally Suggestive/Descriptive | SUPPORTED diag/UNDERDETERMINED prognosis | H^1 non-transport |
| 007 | Vitamin D | Causally Suggestive (MR) | SUPPORTED causal risk | MR positive control |
| 008 | Microbiome | Observationally Consistent to Causally Suggestive | CAUSALLY SUGGESTIVE | Mediation-DAG gluing |
| 009 | EBNA1-GlialCAM | Causally Suggestive | SUPPORTED contributor | Cross-species transport |
| 010 | Deep GM atrophy | Causally Suggestive | SUPPORTED substrate | Bracket-norm #2 |
| 011 | Anti-CD20 | Mechanistically Supported | SUPPORTED treatment/OVERREACH etiology | Age/activity H^1 |
| 012 | Cortical/meningeal | Causally Suggestive | SUPPORTED axis | Bracket-norm #3 |
| 013 | Obesity/BMI | Causally Suggestive (MR) | SUPPORTED causal risk + mediation | MR + mediation template |
| 014 | Remyelination therapy | Observationally Consistent/Descriptive | CAUSALLY SUGGESTIVE biology/DISCONFIRMED therapy | Measurement bottleneck |
| 015 | EDSS validity | Causally Suggestive/DISCONF linearity | Valid disability/WEAK progression measure | Invariance (foundational) |
| 016 | Early high-efficacy DMT | Observationally Consistent to Causally Suggestive | CAUSALLY SUGGESTIVE, confounded-by-indication | Fisher-Rao confound-leakage |
| 017 | HLA-DRB1*15:01 | Causally Suggestive | SUPPORTED genetic risk/mechanism incomplete | Genetic instrument |
| 018 | HLA x EBV interaction | Causally Suggestive | SUPPORTED additive effect-modification | **H^1 exemplar + scale-invariance** |
| 019 | NMOSD/MOGAD vs MS | Causally Suggestive | Distinct entities/imperfect boundary | **MechViews identity criterion (foundational)** |
| 020 | Sex/hormonal | Observationally Consistent to Causally Suggestive | SUPPORTED modifier/mechanism suggestive | Two-axis modifier + pregnancy NE |
...
companions — they are gating PREREQUISITES that must be resolved before Mechanistic Validity scoring is even valid.**
...
positive-control set for a Mechanistic Validity MR-scoring module, contrastable against the confounded associations
...
**Tier assignment:** c1 **Observationally Consistent** (robust association). c2 **DISCONFIRMED by MR** — genetic instruments
...
**Xia hook:** Smoking is the NEGATIVE control for the Mechanistic Validity MR-scoring module (vitamin D / BMI / HLA
...
**Tier assignment:** c1 **Causally Suggestive** (strong, replicated). c2 **Causally Suggestive** (independent predictor) [web:798][web:789].
c3 **Causally Suggestive** (predicts progressive conversion) [web:792]. c4 **Observationally Consistent to Causally Suggestive** (distinct axis; partial independence).

**Verdict:** **SUPPORTED as an independent progression predictor; the "distinct substrate" claim CAUSALLY SUGGESTIVE.**
...
**Tier assignment:** c1 **Causally Suggestive to Mechanistically Supported** (pathway activation demonstrated). c2 **Mechanistically Supported** (RCT efficacy). c3
**Observationally Consistent to Causally Suggestive** — NRF2 is necessary for SOME but not all effects; KO mice reveal NRF2-independent actions
[web:793]. c4 **Observationally Consistent** (neuroprotection-in-MS via antioxidant path is plausible, not proven clinically).
...
**View:** This is a Mechanistic Validity-level claim ABOUT the scoring method itself, instantiated in MS.
...
**Tier assignment:** c1 **Observationally Consistent**. c2 **Causally Suggestive** (MR is a validated causal-screening instrument). c3 **Observationally Consistent to Causally Suggestive**
...
**Contraction:** The atlas is a PRIOR, not a verdict — each factor still needs leg-by-leg Mechanistic Validity
...
**Xia hook:** This IS the Mechanistic Validity MR-scoring module in miniature — a published 65-factor MR atlas [web:802]
...
| Risk factor | Observational | MR verdict | Mechanistic Validity |
|---|---|---|---|
...
**Tier assignment:** c1 **Causally Suggestive** (lesion pathology). c2 **Observationally Consistent to Causally Suggestive** (mechanistic, mechanism-of-progression
oriented). c3 **Observationally Consistent** (transactivation hypothesis, less independently replicated). c4 **Observationally Consistent for
...
**Verdict:** **CAUSALLY SUGGESTIVE as a NEURODEGENERATION/progression mechanism; DISCONFIRMED as an acute-
...
**Tier assignment:** c1 **Causally Suggestive** (large, replicated). c2 **Causally Suggestive** (survives HLA adjustment — controls the
main genetic confounder) [web:805]. c3 **Observationally Consistent to Causally Suggestive** (UV/vitamin D is the leading but not sole candidate).
c4 **Observationally Consistent to Causally Suggestive** (vitamin-D-independent UV immunomodulation demonstrated) [web:811].
...
**Tier assignment:** c1 **Causally Suggestive** (consistent pathology). c2 **Causally Suggestive** (QSM imaging correlation, predictive)
[web:809]. c3 **Observationally Consistent to Causally Suggestive** (mechanistically strong in tissue; human causal lever indirect). c4 **Observationally Consistent to Causally Suggestive**
(cord replication) [web:815].

**Verdict:** **SUPPORTED as a neurodegeneration-associated mechanism; CAUSALLY SUGGESTIVE as a causal, druggable
lever.**
...
"is iron pathogenic?" from "is the iron-rim count a clean measurement?" is the core Mechanistic Validity move.
...
**Tier assignment:** c1 **Causally Suggestive to Mechanistically Supported** (depletion-repopulation documented). c2 **Mechanistically Supported** (RCT durable efficacy).
c3 **Observationally Consistent to Causally Suggestive** (repertoire-shift plausible, incompletely characterized). c4 **Observationally Consistent** — durability does not
...
**Tier assignment:** c1 **Mechanistically Supported** (mechanism-based target engagement). c2 **Mechanistically Supported** (RCT efficacy). c3 **Causally Suggestive**
(trafficking-blockade efficacy DOES support trafficking as a relapse mechanism — one of the stronger
treatment->mechanism inferences, because the target is specific). c4 **Causally Suggestive to Mechanistically Supported** — PML is a PREDICTED,
...
**Tier assignment:** c1 **Mechanistically Supported** (depletion documented). c2 **Causally Suggestive to Mechanistically Supported** (large meta-analytic incidence)
[web:822]. c3 **Causally Suggestive** (reconstitution-timing consistent) [web:828]. c4 **Causally Suggestive** (IL-21 + autoantibody
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive** (replicated association). c2 **Observationally Consistent to Causally Suggestive** (interaction consistently
observed). c3 **Descriptive to Observationally Consistent** (causal-protective vs reverse-causation/confound unresolved — reserve proxies
like education correlate with SES/health behavior).

**Verdict:** **SUPPORTED as an effect-modifier of the damage->disability map; CAUSALLY SUGGESTIVE as a causal
protective factor.**
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive** (large observational). c2 **Observationally Consistent, CONFOUNDING LIVE** (comorbidity
correlates with age, SES, activity, DMT access — confounding by indication/frailty). c3 **Observationally Consistent** (additive
vascular-injury mechanism plausible).

**Verdict:** **CAUSALLY SUGGESTIVE, CONFOUNDING-LIMITED — a second-injury-axis hypothesis needing causal
adjustment.**
...
**Tier assignment:** c1 **Causally Suggestive to Mechanistically Supported** (molecular mechanism robust). c2 **Causally Suggestive but HETEROGENEOUS** (strain/sex-
specific, mechanism-inconsistent across models) [web:864][web:860]. c3 **Descriptive to Observationally Consistent, CONTRADICTORY** — large
cohort null [web:859]. c4 **Descriptive** (no intervention evidence).

**Verdict:** **SUPPORTED mechanistically (in vitro/animal); DISCONFIRMED-to-UNDERDETERMINED epidemiologically
...
**Tier assignment:** c1 **Causally Suggestive**. c2 **Observationally Consistent to Causally Suggestive** (consistent age-of-onset dissociation). c3 **Observationally Consistent to Causally Suggestive**.
c4 **Observationally Consistent to Causally Suggestive** (same disease, age-modified — but younger CNS plasticity/repair modifies expression).
...
disease is established). c2 **Descriptive to Observationally Consistent** (early-phase signals). c3 **Descriptive** (no prevention data). c4 **Descriptive to Observationally Consistent**.
...
**Tier assignment:** c1 **Causally Suggestive** (measurable, replicated). c2 **Causally Suggestive** (distinct biology, interventionally
dissociated) [web:838]. c3 **Observationally Consistent** (taxonomy reform is a normative/definitional argument). c4 **Observationally Consistent to Causally Suggestive**
...
~ (the equivalence relation over phenotypes), which is a MechViews decision, not a Mechanistic Validity score. c4
...
**Tier assignment:** c1 **Causally Suggestive** (biophysically grounded). c2 **Causally Suggestive to Mechanistically Supported** (reproducible tissue + functional
enzymology) [web:871][web:867]. c3 **Causally Suggestive** (mechanistic chain well-supported). c4 **Observationally Consistent to Causally Suggestive** (convergence
...
claim CAUSALLY SUGGESTIVE to SUPPORTED and highly attractive as a unifying node.**
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive** (links to iMSMS, 008). c2 **Causally Suggestive** (consistent immunology) [web:880].
c3 **Observationally Consistent** (propionate add-on signals, not confirmatory RCT) [web:868]. c4 **Observationally Consistent** (SCFA is ONE mediator
...
**Tier assignment:** c1 **Causally Suggestive** (robust GWAS). c2 **Causally Suggestive** (immune-cell regulatory enrichment is a strong,
replicated functional-genomics result). c3 **Observationally Consistent to Causally Suggestive** (PRS predictive but modest AUC). c4 **Observationally Consistent to Causally Suggestive** —
...
**Tier assignment:** c1 **Observationally Consistent to Causally Suggestive** (immunosenescence). c2 **Observationally Consistent, CONFOUNDING/SELECTION LIVE** (who is
selected to stop?). c3 **Observationally Consistent to Causally Suggestive** (age-modification of efficacy) [web:844]. c4 **Descriptive** (no validated
universal criterion).

**Verdict:** **CAUSALLY SUGGESTIVE, SELECTION-LIMITED — de-escalation is reasonable in selected older stable
...
- CP volume predicted 4-year EDSS better than Observationally Consistent/Gd lesion counts [web:896].

**Tier assignment:** c1 **Causally Suggestive** (replicated, MS-specific) [web:896]. c2 **Causally Suggestive** (multimodal MRI+PET
convergence) [web:890][web:891]. c3 **Observationally Consistent to Causally Suggestive** (PIRA prediction, moderate AUC) [web:890]. c4 **Observationally Consistent**
(gateway mechanism plausible, causal lever unproven).

**Verdict:** **SUPPORTED as an inflammation-degeneration BRIDGING biomarker; CAUSALLY SUGGESTIVE as a causal
...
**Tier assignment:** c1 **Observationally Consistent** (mixed). c2 **Observationally Consistent to Causally Suggestive** (coherent with EBV, 001). c3 **Observationally Consistent to Causally Suggestive** (H. pylori/
Toxoplasma associations replicated but observational, reverse-causation possible) [web:883][web:885].
c4 **Descriptive to Observationally Consistent** (immunoregulatory mechanism plausible, human causal proof absent).

**Verdict:** **CAUSALLY SUGGESTIVE, CONFOUNDING-HEAVY — the "old friends" inverse associations are the strongest
strand; the general hygiene claim is UNDERDETERMINED.**
...
**Tier assignment:** c1 **Observationally Consistent** (proxy measures, contested validity). c2 **Observationally Consistent** (reported, small studies).
c3 **Observationally Consistent** (associations). c4 **Descriptive to Observationally Consistent** (causal role hypothetical; directionality unresolved — does
...
**Tier assignment:** c1 **Causally Suggestive to Mechanistically Supported** (universally observed). c2 **Observationally Consistent to Causally Suggestive** (PRL/CP correlation) [web:893].
c3 **Observationally Consistent** (construct validity partial — confounded by mood/sleep). c4 **Observationally Consistent** (PROs accepted as SECONDARY;
...
**Tier assignment:** c1 **Causally Suggestive to Mechanistically Supported** (large autopsy series). c2 **Causally Suggestive** (quantitative correlation) [web:901].
c3 **Causally Suggestive** (clinical-course difference across F+/F-) [web:897]. c4 **Causally Suggestive** — the pial-to-deep neuronal-loss
...
**Tier assignment:** c1 **Causally Suggestive** (established but technically demanding). c2 **Causally Suggestive** (replicated). c3 **Causally Suggestive**
(cortical-sodium/SPMS association) [web:902]. c4 **Observationally Consistent to Causally Suggestive** — sodium rise is MECHANISTICALLY tied to
...
**Tier assignment:** c1 **Causally Suggestive** (replicated clinic cohorts) [web:900]. c2 **Observationally Consistent to Causally Suggestive** (insurance-adjusted,
but residual SES/access/environmental confounding LIVE) [web:900]. c3 **Descriptive to Observationally Consistent** (ancestry-vs-social
determinants NOT disentangled — the core confound). c4 **Descriptive to Observationally Consistent, LIKELY NON-TRANSPORT** — most mechanism
...
**Tier assignment:** c1 **Causally Suggestive** (from 045). c2 **Observationally Consistent to Causally Suggestive** (correlational unification, plausible). c3 **Observationally Consistent,
OVERREACH** — competing drivers (037,027) are not clearly downstream. c4 **Descriptive to Observationally Consistent** — anti-CD20's
...
**Tier assignment:** c1 **Causally Suggestive to Mechanistically Supported** (BCR sequencing + plasmablast data). c2 **Causally Suggestive** (structural mimicry
mapped) [web:731]. c3 **Causally Suggestive** (multi-cohort replication) [web:914]. c4 **Observationally Consistent to Causally Suggestive** — mouse-model support is
...
scored at THREE tiers with DIFFERENT verdicts (Causally Suggestive necessity, Causally Suggestive mechanism, Descriptive therapy) — the clearest
...
**Tier assignment:** c1 **Causally Suggestive** (astrocytic biology). c2 **Causally Suggestive** (replicated) [web:910]. c3 **Causally Suggestive** (GFAP >
NfL for progression) [web:915][web:918]. c4 **Causally Suggestive** — the GFAP/NfL dissociation is replicated and
...
**Tier assignment:** c1 **Causally Suggestive** (adolescent obesity). c2 **Causally Suggestive** (MR, from 013) [web:718]. c3 **Observationally Consistent to Causally Suggestive**
(interaction/mediation plausible and partly evidenced; formal interaction MR less established). c4 **Observationally Consistent to Causally Suggestive**.

**Verdict:** **SUPPORTED that both are causal; the INTERACTION/mediation (obesity acting partly THROUGH
vitamin D) is CAUSALLY SUGGESTIVE to SUPPORTED but not a clean MR interaction estimate.**
...
**Tier assignment:** c1 **Causally Suggestive** (clinical descriptors acknowledged). c2 **Causally Suggestive** (continuum from PIRA data)
[web:838]. c3 **Observationally Consistent to Causally Suggestive** (parsimonious 2-axis continuum well-supported). c4 **Observationally Consistent** (pattern stability
contested; single patient may not have one fixed pattern).

**Verdict:** **A DEFINITIONAL (MechViews) question, not a Mechanistic Validity score: current evidence favors a
...
at three tiers: necessity Causally Suggestive (001), mimicry mechanism Causally Suggestive (049), therapy Descriptive (035). Same cause, three
...
and the whole Mechanistic Validity program becomes: locate each scored mechanism's action on the (relapse,progression)
