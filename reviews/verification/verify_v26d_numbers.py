"""Check every Amendment 5 number printed in paper_v26d_round4.tex against the files that produced it.
...
TEX = (ROOT / "paper" / "paper_v26d_round4.tex").read_text(encoding="utf-8")
...
check("section-sign markers >= 16 and note present", TEX.count(r"$^\S$") >= 16 and "Value differs from what its source reports" in TEX)
