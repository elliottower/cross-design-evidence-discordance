"""Check every Amendment 5 number printed in paper_v26c_round4.tex against the files that produced it.
...
TEX = (ROOT / "paper" / "paper_v26c_round4.tex").read_text(encoding="utf-8")
...
check("range 17/25 to 23/28 stated", has("runs from 17/25 (68.0\\%) to 23/28 (82.1\\%)") and has("the count runs from 17/25 to 23/28"))
# --- IL6-MDD
...
check("appendix agreement 48 of 62 (77%)", vo["numeric_agree"] == 48 and vo["numeric_checked"] == 62 and has("48 of the 62 (77\\%) agree with it"))
check("appendix counts 34/5/9/14", vo["numeric"] == {"quoted": 34, "replacement_citation": 5, "derived": 9, "coding_error": 14, "not_checked": 2} and has("34 appear in the source cited, 5 appear in a source other than the one previously cited, and 9 are stated transformations") and has("14 values do not match"))
