"""Check every Amendment 5 number printed in paper_v26m_round4.tex against the files that produced it.
...
TEX = (ROOT / "paper" / "paper_v26m_round4.tex").read_text(encoding="utf-8")
