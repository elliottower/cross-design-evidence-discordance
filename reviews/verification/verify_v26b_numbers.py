"""Check every Amendment 5 number printed in paper_v26b_round4.tex against the files that produced it.
...
TEX = (ROOT / "paper" / "paper_v26b_round4.tex").read_text(encoding="utf-8")
...
check("urate cites Jordan 2019", TEX.count(r"\cite{jordan2019urate}") == 2 and r"\cite{li2019uratemr}" not in TEX)
...
expected = {"registered": (32, 24), "strict Phase III": (25, 17), "Amyloid-AD scored": (33, 24), "strict Phase III + Amyloid-AD": (26, 17),
            "MR-instrumented": (27, 22), "MR-instrumented (unresolved also removed)": (26, 21), "registration-consistent instrument": (32, 24),
...
for n, k, pct in [(32, 24, "75.0"), (25, 17, "68.0"), (33, 24, "72.7"), (26, 17, "65.4"), (27, 22, "81.5"), (26, 21, "80.8"), (31, 23, "74.2"), (25, 20, "80.0"), (27, 21, "77.8"), (28, 23, "82.1")]:
